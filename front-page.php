...
$appliances = [
    ...
    ['icon' => 'cooktop',     'label' => 'Cooktop Repair',       'service_slug' => 'viking-cooktop-repair',       'img' => '48InductionHomepageSlide2025-2.png',    'desc' => 'Viking gas, electric, and induction cooktops. Burner ignition, spark module, and surface element failures fixed with genuine OEM parts.'],
    ...
    ['icon' => 'freezer',     'label' => 'Freezer Repair',       'service_slug' => 'viking-freezer-repair',       'img' => 'viking-refrigerator-integrated.jpg',   'desc' => 'Viking built-in column and upright freezers. Defrost system faults, temperature alarms, frost buildup, and evaporator fan failures resolved.'],
    ['icon' => 'hood',        'label' => 'Vent Hood Repair',     'service_slug' => 'viking-vent-hood-repair',     'img' => 'viking-5series-kitchen.jpg',           'desc' => 'Viking Professional vent hoods. Blower motor failures, lighting faults, and control panel issues repaired with genuine Viking OEM parts.'],
];
