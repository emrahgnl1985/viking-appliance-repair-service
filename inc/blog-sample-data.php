...
$posts = [
    ...
    [
        ...
        'image'    => get_template_directory_uri() . '/assets/images/gas-range.jpg',
...
<figure><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/gas-range.jpg' ); ?>" alt="Viking professional gas range — not heating diagnosis guide" loading="lazy"></figure>
...
HTML,
    ...
    [
        ...
        'image'    => get_template_directory_uri() . '/assets/images/wall-oven.jpg',
...
<figure><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/wall-oven.jpg' ); ?>" alt="Viking wall oven F-code fault code guide" loading="lazy"></figure>
...
HTML,
    ...
    [
        ...
        'image'    => get_template_directory_uri() . '/assets/images/product-refrigerator.jpg',
...
<figure><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/product-refrigerator.jpg' ); ?>" alt="Viking built-in refrigerator not cooling — diagnosis guide" loading="lazy"></figure>
...
<figure><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/product-dishwasher.jpg' ); ?>" alt="Viking dishwasher not cleaning properly — causes and fixes" loading="lazy"></figure>
...
HTML,
    ...
    [
        ...
        'image'    => get_template_directory_uri() . '/assets/images/kitchen-set-2.webp',
...
<figure><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/kitchen-set-2.webp' ); ?>" alt="Viking appliance annual maintenance — kitchen setup" loading="lazy"></figure>
...
<figure><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/gas-range.jpg' ); ?>" alt="Viking Professional Series range comparison guide" loading="lazy"></figure>
...
<figure><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/gas-range.jpg' ); ?>" alt="Viking gas cooktop burner ignition troubleshooting" loading="lazy"></figure>
