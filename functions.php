...
function ar_output_seo_meta():void{
    ...
    if(is_singular()){
        ...
        elseif($pt==='location_page'){$c=ar_meta($id,'_ar_city','');$s=ar_meta($id,'_ar_state','');$title="Appliance Repair in $c, $s | Same-Day Service | All Major Brands";$desc="Top-rated appliance repair in $c. Certified technicians, OEM parts, 30-day warranty.";}
